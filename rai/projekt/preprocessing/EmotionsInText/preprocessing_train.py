...
# Count frequency of each emotion text in preprocessed dataset
emotions_frequency = df_cleared['Emotion'].value_counts()                   
...
# Get the half from downsampled original dataset. 
# First half is left as training data, second will be downsampled in relation 60/40 <-> test/valid
...
# Rename labels to numbers for TensorFlow workflow
